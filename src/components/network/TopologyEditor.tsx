...
import { Plus, MousePointer2, Network, Trash2, Settings2 } from 'lucide-react';
import { useSimulation } from '../../context/SimulationContext';
import { PacketSender } from '../controls/PacketSender';

export const TopologyEditor = () => {
  const [mode, setMode] = useState<'view' | 'add-node' | 'add-link'>('view');
